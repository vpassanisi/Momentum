<template>
  <section v-if="sub">
    ...
    />
    <div
      class="flex items-start justify-center bg-white dark:bg-dark-gray-800 shadow-default"
    >
      <div class="w-11/12 max-w-screen-lg flex flex-row">
        <div
        ...
        <div class="flex items-center justify-center text-4xl font-medium pl-4">
          {{ sub.name }}
        </div>
      </div>
    </div>
    <section class="flex justify-center pt-8">
      <div
        class="grid gap-6 grid-cols-1 md:grid-cols-3 w-11/12 max-w-screen-lg"
      >
...
import PostC from "../components/Post.vue";
