<template>
  <nav
    class="fixed z-10 top-0 left-0 w-full flex flex-row items-center justify-center bg-white dark:bg-dark-gray-900 transition-height duration-500 ease-in-out border-b border-gray-500"
