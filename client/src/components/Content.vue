      ...
      <div class="md:col-span-2">
        ...
        >
          <button
            ...
            :class="[sort === 'createdat' ? 'bg-gray-200 dark:bg-dark-gray-700': '']"
          ...
          <button
            ...
            :class="[sort === 'points' ? 'bg-gray-200 dark:bg-dark-gray-700': '']"
            @click="sort = 'points'"
          >
            <svg class="fill-current inline h-full w-8 mr-2" viewBox="0 0 512.002 512.002">
              <g>
                <path
